...
class VulkanInstance {
 public:
  VulkanInstance() : instance_(VK_NULL_HANDLE) {}
  ...
  VkResult Init(bool enable_validation_layers,
    ...
    if (enable_validation_layers_) {
      ...
      debug_create_info.pfnUserCallback = Log::DebugCallback;
  ...
  void Destroy() { vkDestroyInstance(instance_, nullptr); }

  VkInstance GetInstance() { return instance_; }

  bool ValidationLayersEnabled() const { return enable_validation_layers_; }
